package by.vorakh.dev.fibo.web.configuration;

import by.vorakh.dev.fibo.jdbc.configuration.FiboCounterConfiguration;
...
import by.vorakh.dev.fibo.web.service.impl.TaskServiceImpl;
...
@Import({FiboCounterConfiguration.class, RedisConfiguration.class})
